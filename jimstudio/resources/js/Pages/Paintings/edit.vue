<template>
    <backend-layout>
        <h2 class = "text-center text-4xl mb-10 tracking-wider">Edit Painting</h2>
            ...
            <form @submit.prevent = "submit">
                <div class = "flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class = "w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <textarea
                            class = "appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white-500"
                            name = "notes" id = "painting-notes" cols = "30" rows = "10" placeholder = "Painting Notes"
...
<script>
import backendLayout from "@/Layouts/AuthenticatedLayout";
...
export default {
    ...
    setup(props) {
        ...
        function submit() {
            Inertia.put(route('painting.update', form.id));
            form.title = null;
            form.category = null;
            form.size = null;
            form.medium = null;
